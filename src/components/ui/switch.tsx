...
/** margin-inline-start במקום translate — כך המתג זז לכיוון הנכון גם בעברית */
...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-6 w-6 rounded-full bg-foreground shadow-lg ring-0 transition-[margin] duration-200 data-[state=checked]:ms-5 data-[state=unchecked]:ms-0",
      )}
    />
  </SwitchPrimitives.Root>
));
